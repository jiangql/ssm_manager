						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${permissionList}" var="p" varStatus="i">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${p.id}" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
